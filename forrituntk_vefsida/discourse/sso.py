"""
Source: https://github.com/tindie/pydiscourse/blob/master/pydiscourse/sso.py
...
def sso_validate(payload, signature, secret):
    ...
    if None in [payload, signature]:
        raise Exception('No SSO payload or signature.')
    ...
    if this_signature != signature:
        raise Exception('Payload does not match signature.')
